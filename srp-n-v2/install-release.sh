...
downloadV2Ray(){
    ...
    DOWNLOAD_LINK="https://github.com/supersongssr/own-srp-v2ray-plugin/releases/download/${NEW_VER}/v2ray-linux-${VDIS}.zip"
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/supersongssr/own-srp-v2ray-plugin/releases/latest"
